...
Use this skill when `grok:grok-rescue` needs to tighten a user request into a better Grok prompt.
...
Concrete end-to-end templates live in [references/prompt-recipes.md](references/prompt-recipes.md).
Common failure modes to avoid live in [references/prompt-antipatterns.md](references/prompt-antipatterns.md).
